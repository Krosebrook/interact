...
### This Repository: `Krosebrook/interact`

**Tech Stack**:
- **Frontend**: React 18 + Vite 6 + Tailwind CSS + Radix UI
- **Backend**: Base44 SDK (61 serverless functions)
- **State**: React hooks and context
- **Routing**: React Router

**Key Patterns**:
- **Auth**: Base44 authentication (check existing functions)
- **Validation**: Manual checks + Zod schemas (gradual adoption)
...
- Focus on employee engagement & gamification
