        ...
        <div className="space-y-4">
          <div>
            ...
            <Textarea
              ...
              placeholder="e.g., 'We're a tech startup with a casual culture. Team loves gaming and pop culture. We value creativity and humor...'"
              rows={4}
            ...
            >
              ...
              <SelectContent>
                <SelectItem value="conservative">
                  Conservative - Stick to proven activities
                </SelectItem>
                <SelectItem value="balanced">
                  Balanced - Mix of safe and new ideas
                </SelectItem>
                <SelectItem value="creative">
                  Creative - Push boundaries with novel suggestions
                </SelectItem>
              </SelectContent>
            </Select>
          </div>
